...
description: Bridge between TeamWork UI and OpenCode runtime
---

## Overview

TeamWork communicates with OpenCode via three mechanisms:
...
TeamWork can register as an MCP server that OpenCode connects to.
...
### Use cases
- Real-time permission prompts surfaced in TeamWork UI.
- Streaming progress updates.
- Custom tools exposed from TeamWork (e.g., native file picker).
