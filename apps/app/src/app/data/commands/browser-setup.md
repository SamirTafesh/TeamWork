...
Try browser automation in TeamWork right away.
...
- Instead, tell the user the shortest exact steps to connect `Control Chrome` from TeamWork's MCP tab, then ask them to retry.
