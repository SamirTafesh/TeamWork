...
export default {
  ...
  "app.plugins_hint_readonly": "TeamWork server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "TeamWork server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "chrome_setup.connected_message": "Chrome is connected. TeamWork can now control your browser, including your tabs, cookies, and sign-ins.",
  "chrome_setup.docs_link": "Chrome remote debugging docs",
  "chrome_setup.done": "Done",
  "chrome_setup.info_what_this_enables": "When connected, TeamWork can navigate tabs, fill forms, and read pages in your real Chrome — including sites where you're signed in. You can disconnect at any time by disabling remote debugging in Chrome.",
  ...
  "chrome_setup.step_two_hint": "After enabling remote debugging, click the button below to verify TeamWork can reach Chrome.",
  "chrome_setup.step_two_title": "Test the connection",
  "chrome_setup.subtitle": "Let TeamWork control your real Chrome browser — your tabs, cookies, and sign-ins — so it can work with sites where you're already logged in.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected TeamWork servers.",
  ...
  "config.server_needed_hint": "TeamWork server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an TeamWork server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "TeamWork server",
  ...
  "config.server_sharing_title": "TeamWork server sharing",
  "config.server_url_hint": "Use the URL shared by your TeamWork server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "TeamWork server URL",
  "config.server_url_label": "TeamWork Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable TeamWork server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "TeamWork server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "TeamWork server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "TeamWork server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable TeamWork server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted TeamWork worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted TeamWork worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an TeamWork server as a workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Sign in to TeamWork Cloud to access workers shared with your organization.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the TeamWork server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted TeamWork worker.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and TeamWork will reconnect here automatically.",
  ...
  "den.cloud_sleep_hint": "Sign in to TeamWork Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use TeamWork Cloud.",
  "den.cloud_workers_hint": "Open workers directly into TeamWork using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but TeamWork Cloud did not return a session token.",
  "den.error_open_worker": "Failed to open {name} in TeamWork.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid TeamWork sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete TeamWork Cloud sign-in.",
  ...
  "den.signin_code_note": "Accepts an teamwork://den-auth link or the raw one-time grant.",
  "den.signin_link_hint": "If your browser doesn't bounce back into TeamWork automatically, paste the sign-in link or one-time code from TeamWork Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "teamwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to TeamWork Cloud",
  "den.signing_in": "Finishing TeamWork Cloud sign-in...",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect TeamWork.",
  "den.status_browser_signup": "Finish account creation in your browser to connect TeamWork.",
  "den.status_cloud_signed_in_as": "Connected TeamWork Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected TeamWork Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in TeamWork.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your TeamWork Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an TeamWork host.",
  "identities.connect_server_title": "Connect to an TeamWork server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check TeamWork URL/token and try again.",
  ...
  "mcp.toggle_requires_server": "Connect to an TeamWork server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so TeamWork can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, TeamWork needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, TeamWork needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize TeamWork",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from TeamWork.",
  ...
  "welcome.title": "Welcome to TeamWork",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. TeamWork will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and TeamWork can pick them up.",
  "plugins.add": "Add",
  ...
  "session.share_local_host_not_ready": "Local TeamWork host is not ready yet.",
  "session.share_missing_host_url": "Missing TeamWork host URL.",
  "session.share_missing_token": "Missing TeamWork token.",
  ...
  "session.share_teamwork_workers_only": "Share service links are available for TeamWork workers.",
  ...
  "settings.background_checks_desc": "TeamWork checks on launch and when this page opens.",
  ...
  "settings.capabilities_title": "TeamWork server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point TeamWork at a local OpenCode build",
  ...
  "settings.debug_teamwork_server_version": "TeamWork server: {version}",
  ...
  "settings.deeplink_hint": "Accepts teamwork://, teamwork-dev://, or a raw supported https://share.teamworklabs.com/b/... URL.",
  ...
  "settings.docker_containers_desc": "Force-remove Docker containers launched by TeamWork",
  "settings.docker_containers_title": "TeamWork Docker containers",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by TeamWork. Off by default.",
  ...
  "settings.feedback_title": "Help shape TeamWork",
  ...
  "settings.open_deeplink_desc": "Paste an TeamWork deeplink or share URL to open it.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by TeamWork.",
  ...
  "settings.teamwork_config_sidecar_desc": "Local TeamWork server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.teamwork_diagnostics_title": "TeamWork server diagnostics",
  "settings.teamwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.teamwork_server_label": "TeamWork server",
  ...
  "settings.quit_hint": "TeamWork quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect TeamWork server.",
  "settings.reconnected": "Reconnected to TeamWork server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears TeamWork cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears TeamWork cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. TeamWork will restart.",
  ...
  "settings.reset_onboarding_description": "Clears TeamWork preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears TeamWork local preferences and workspace onboarding markers.",
  "settings.reset_teamwork_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside teamwork-dev-data.",
  "settings.reset_teamwork_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside teamwork-dev-data.",
  "settings.reset_teamwork_title": "Reset TeamWork + OpenCode state",
  ...
  "settings.restart_blocked_message": "TeamWork needs to restart to finish this update. To avoid interrupting your current work, install is paused until your active runs finish or you stop them.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_teamwork_server": "Restart TeamWork server",
  ...
  "settings.services_section_desc": "Local services that power this TeamWork session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting TeamWork.",
  ...
  "settings.runtime_desc": "Status for your local engine and TeamWork server.",
  ...
  "settings.tab_description_appearance": "Adjust how TeamWork looks across desktop, system theme, and app chrome.",
  "settings.tab_description_debug": "Review runtime diagnostics, logs, and low-level debugging utilities.",
  "settings.tab_description_den": "Manage your TeamWork Cloud connection, hosted workers, and workspace access.",
  "settings.tab_description_extensions": "Manage MCP apps and OpenCode plugins for this workspace.",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected TeamWork workspace plus its runtime connection.",
  ...
  "settings.updates_desc": "Keep TeamWork up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an TeamWork host, then choose it from the list to import this skill.",
  ...
  "skills.add_teamwork_hub": "Add TeamWork Hub",
  ...
  "skills.cloud_section_subtitle": "Skills shared with you through TeamWork Cloud — including team skill hubs you can access.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to TeamWork Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected TeamWork server.",
  ...
  "skills.share_chooser_subtitle": "Save to your TeamWork Cloud organization or publish a public install link.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active TeamWork Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active TeamWork Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "TeamWork Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full TeamWork features",
  ...
  "status.teamwork_ready": "TeamWork Ready",
  ...
  "system.reload_body_default": "TeamWork detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "TeamWork detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "TeamWork can't load tasks from this worker until the connection is fixed.",
