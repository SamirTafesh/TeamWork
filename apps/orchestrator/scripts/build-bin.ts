...
const serverBin = resolve(root, "..", "server", "dist", "bin", "teamwork-server");
...
await copyFile(serverBin, resolve(targetDir, "teamwork-server"));
...
const versions = {
  "teamwork-server": {
    ...
    sha256: await sha256(resolve(targetDir, "teamwork-server")),
  },
  "opencode-router": {
