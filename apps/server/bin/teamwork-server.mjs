...
const binaryName = process.platform === "win32" ? "teamwork-server.exe" : "teamwork-server";
...
console.error(
  `Unable to find an TeamWork server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
