---
title: "Get started with TeamWork Cloud"
description: "Connect the desktop app to your TeamWork Cloud org and unlock shared workspaces, skill hubs, and shared providers"
---

TeamWork Cloud requires an active subscription at [app.teamworklabs.com](https://app.teamworklabs.com/).
It is intended for teams what want to share `SKILLs.md`, `MCPs` and `configs`. 


First, you should connect your desktop app with Teamwork Cloud.

<Frame>
  ![TeamWork Cloud org settings with organization identity, allowed email domains, and desktop restrictions](/images/cloud-org-settings.png)
</Frame>

1. Open [app.teamworklabs.com](https://app.teamworklabs.com/) in your browser.
2. Click `Create organization`.
3. Enter your org name.
4. Finish checkout if TeamWork Cloud asks for billing.
...
1. Open the `dashboard/org_settings` [page](https://app.teamworklabs.com/dashboard/org-settings) in the cloud app.
...
4. If the browser does not return to TeamWork automatically, click `Paste sign-in code`, paste the `teamwork://den-auth?...` link or one-time code from TeamWork Cloud, then click `Finish sign-in`.
...
- Use [Shared workspaces](/cloud/run-in-the-cloud/shared-workspace) to deploy hosted TeamWork runtimes that teammates can open from the desktop app.
