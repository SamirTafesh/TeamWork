...
In order to connect `slack` with your teamwork `workspace`, you will need the following:

1. Valid slack admin permissions to add an app
2. Create a simple slack app
3. Connect said slack app with your workspace

This is one of the most relevant and meaningful applications of Teamwork, and we use it daily ourselves.
...
For team-owned Slack or other long-running connectors, you can host the runtime in an TeamWork Cloud [shared workspace](/cloud/run-in-the-cloud/shared-workspace) instead of keeping it on a laptop or self-managed server.
