...
Skill hubs are the team-wide way to distribute grouped skills in TeamWork Cloud. You create the skills and team assignments in the Cloud dashboard, then each desktop workspace can import the hub in one step.
...
If you do not already have one, open [app.teamworklabs.com](https://app.teamworklabs.com/), click `Create organization`, enter the org name, and finish checkout if prompted.
...
<Frame>
  ![Skill hub access and included skills in TeamWork Cloud](/images/cloud-skill-hub-access-and-skills.png)
</Frame>
...
4. Reload the workspace when TeamWork asks.

TeamWork installs the hub's skills into `.opencode/skills` for that workspace.
