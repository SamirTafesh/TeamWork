...
description: "Create reusable workspace templates for teams in TeamWork Cloud"
---
...
- Use [Skill hubs](/cloud/share-with-your-team/skill-hubs) when you only need to distribute skills.
- Use [managed providers](/cloud/share-with-your-team/managed-llm-provider) when the only shared piece is model access.

## Recommended flow

1. Build the workspace locally in the TeamWork desktop app.
2. Add the skills, MCP servers, commands, agents, and providers the team should start with.
3. Share the setup to your TeamWork Cloud organization.
...
- Keep reusable skills in skill hubs when several templates need the same skill set.
