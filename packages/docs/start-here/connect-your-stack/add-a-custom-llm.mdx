...
We've also built a [custom skill](https://share.teamworklabs.com/b/01KNBQDQAK41VZSZDF5G9MW4MW) that you can import in TeamWork following [this guide](/start-here/do-work-with-it/import-a-skill).

The following tutorial covers how to [import a custom provider using the skill](https://x.com/getteamwork/status/2034129039317995908?s=20).
...
For teams, you can manage the provider in TeamWork Cloud under [LLM Providers](/cloud/share-with-your-team/managed-llm-provider), then import it into each workspace from `Settings -> Cloud`.