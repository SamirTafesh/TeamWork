...
description: "How to connect a custom MCP server with teamwork"
---

Connecting a custom MCP server with teamwork takes four clicks.
...
Once in their Oath page, you should just continue with the registration or custom setup. It should redirect back to teamwork. Feel free to [open an issue](https://github.com/SamirTafesh/TeamWork/issues/) if you require a custom MCP that we currently do not support.
