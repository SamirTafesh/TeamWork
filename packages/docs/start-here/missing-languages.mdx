...
description: "See which TeamWork languages ship today and help us improve them."
---

TeamWork already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="TeamWork missing languages overview"
...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/SamirTafesh/TeamWork/tree/dev/apps/app/src/i18n/locales).
...
If you want to add a new language to TeamWork, the basic file changes are:
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/SamirTafesh/TeamWork/issues/1385).
