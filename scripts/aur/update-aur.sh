...
VERSION="${TAG#v}"
ASSET_NAME_AMD64="${AUR_ASSET_NAME:-teamwork-linux-x64-${VERSION}.tar.gz}"
ASSET_NAME_ARM64="teamwork-linux-arm64-${VERSION}.tar.gz"
ASSET_URL_AMD64="https://github.com/SamirTafesh/TeamWork/releases/download/${TAG}/${ASSET_NAME_AMD64}"
ASSET_URL_ARM64="https://github.com/SamirTafesh/TeamWork/releases/download/${TAG}/${ASSET_NAME_ARM64}"
