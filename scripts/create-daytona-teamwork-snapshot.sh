...
SNAPSHOT_NAME="${1:-${DAYTONA_SNAPSHOT_NAME:-teamwork-runtime}}"
...
LOCAL_IMAGE_TAG="${DAYTONA_LOCAL_IMAGE_TAG:-teamwork-daytona-snapshot:${SNAPSHOT_NAME//[^a-zA-Z0-9_.-]/-}}"
...
echo "- teamwork-orchestrator@$TEAMWORK_ORCHESTRATOR_VERSION" >&2
