...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "teamwork-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "SamirTafesh/TeamWork"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "teamwork-download-stats",
  }
